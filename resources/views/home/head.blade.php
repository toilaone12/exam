...
<title>{{$title ? $title : 'Học tiếng Đức với Decamy, tự học tiếng Đức online'}}</title>
<link rel="icon" href="{{asset('fe/image/favicon-decamy-637031281346427270.ico')}}">
...
<link rel="stylesheet" href="{{asset('fe/css/font.css')}}">
